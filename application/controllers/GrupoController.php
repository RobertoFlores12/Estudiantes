...
class GrupoController extends CI_Controller
{
    ...
    public function add()
    {
        ...
        $this->form_validation->set_rules("idgrupo", "Id Grupo", "required|min_length[3]|max_length[12]|is_unique[grupos.idgrupo]");
    ...
    public function report_todos_los_grupos()
    {
        ...
        foreach ($grupos as $grupo) :
            $this->table->add_row($grupo->idgrupo, $grupo->num_grupo, $grupo->anio, $grupo->ciclo, $grupo->materia, $grupo->nombre);
        endforeach;
